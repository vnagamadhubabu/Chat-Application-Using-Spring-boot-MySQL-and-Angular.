...
public class controller {
	...
	@GetMapping("/gopiToRavi")
	public List<gopiToRaviChat> getChatgopiToRavi() {
		return gopiToRaviREPO.findAll();
	}
	
	@GetMapping("/ramToGopi")
	public List<ramToGopiChat> getChatRamToGopi() {
		return ramToGopiREPO.findAll();
	}
	
	@GetMapping("/raviToGopi")
	public List<raviToGopiChat> getChatRaviToGopi() {
		return raviToGopiREPO.findAll();
	}
	
	@GetMapping("/ramToGroup")
	public List<ramToGroupChat> getChatRamToGroup() {
		return ramToGroupREPO.findAll();
	}
	
	@GetMapping("/raviToGroup")
	public List<raviToGroupChat> getChatRaviToGroup() {
		return raviToGroupREPO.findAll();
	}
	
	@GetMapping("/gopiToGroup")
	public List<gopiToGroupChat> getChatGopiToGroup() {
		return gopiToGroupREPO.findAll();
	}
	...
	@PostMapping("/ramToGroup/{message}")
	...
	@PostMapping("/raviToGroup/{message}")
	...
	@PostMapping("/gopiToGroup/{message}")
